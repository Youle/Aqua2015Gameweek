...
EntityPlayer = ig.Entity.extend({
	...
	changeGround: function()
	{
		...
		var currentTile = ig.game.backgroundMaps[0].getTile(this.pos.x + this.size.x/2,this.pos.y + this.size.y);
		if(ig.idTile.idGroundDry.indexOf(currentTile) !== -1)
		{
			ig.stats.tank -= ig.stats.groundCost;
			ig.game.backgroundMaps[0].setTile(this.pos.x + this.size.x/2,this.pos.y + this.size.y, currentTile + ig.idTile.plusIndexGroundWet);
		}
		else if(ig.idTile.idGroundLava.indexOf(currentTile) !== -1){
			ig.stats.tank -= ig.stats.lavaCost;
			ig.game.backgroundMaps[0].setTile(this.pos.x + this.size.x/2,this.pos.y + this.size.y, currentTile + ig.idTile.plusIndexGroundLava);
		}
